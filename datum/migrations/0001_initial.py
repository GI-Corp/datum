    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registered_date', models.DateTimeField(default=datetime.datetime(2021, 7, 9, 13, 40, 28, 468959))),
                ('last_update_date', models.DateTimeField(null=True)),
                ('interest', models.ManyToManyField(blank=True, related_name='profile_interests', to='datum.Interest')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pref_min_age', models.IntegerField(default=0)),
                ('pref_max_age', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_accepted', models.BooleanField(default=False, help_text='if user accepts your match then, this switches to True')),
                ('is_active', models.BooleanField(default=True, help_text='used to remove match connection')),
